...
\begin{itemize}
	...
	\begin{equation}
		\dot{m}_{H_2} = \frac{I}{2\mathscr{F}}\times M_{H_2} \times N_{Cell} \times A_{cell} \label{eq2.7}
	\end{equation}
...
\begin{equation}
	E_{\text{from H2}} = \frac{m_{\text{hydro}}[i] \cdot LHV_{\text{hydrogen}}}{M_{\text{olar mass H2}}} \quad \text{if } m_{\text{hydro}}[i] > 0
\end{equation}
